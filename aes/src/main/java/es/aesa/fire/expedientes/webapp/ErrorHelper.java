...
public class ErrorHelper {
     ...
     */
    public static TransactionResult recoverErrorResult(final HttpServletRequest request, final HttpServletResponse response)
    	...
    	final String appId =  "CB0A1CFA4D1B";
		...
		try {
        	...
        	result = fireClient.recoverErrorResult(transactionId, subjectId);
